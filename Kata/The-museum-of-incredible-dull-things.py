...
# https://www.codewars.com/kata/remove-the-minimum/python
...
def remove_smallest(numbers):
	if numbers != []:
		numero = []
		[numero.append(num) for num in numbers]
		numero.remove(min(s for s in numbers))
		return numero
	else:
		return numbers
...
print(remove_smallest([69, 126, 188, 131, 38, 145]),[69, 126, 188, 131, 38, 145])